...
public class AirlineStatisticsServiceTest {
        ...
        @Test
        public void testGetAirlinecount_NonExistentAirline_ThrowsException() {
                // Act & Assert
                ResourceNotFoundException exception = assertThrows(
                                ResourceNotFoundException.class,
                                () -> airlineStatisticsService.getAirlinecount("NonExistentAirline"));
                assertEquals("Airline not found with name: NonExistentAirline", exception.getMessage());
        }

        @Test
        public void testGetAirlineAvgRating_NonExistentAirline_ThrowsException() {
                // Act & Assert
                ResourceNotFoundException exception = assertThrows(
                                ResourceNotFoundException.class,
                                () -> airlineStatisticsService.getAirlineAvgRating("InvalidAirline"));
                assertEquals("Airline not found with name: InvalidAirline", exception.getMessage());
        }

        @Test
        public void testGetAirlineRevenue_NonExistentAirline_ThrowsException() {
                // Act & Assert
                ResourceNotFoundException exception = assertThrows(
                                ResourceNotFoundException.class,
                                () -> airlineStatisticsService.getAirlineRevenue("FakeAirline"));
                assertEquals("Airline not found with name: FakeAirline", exception.getMessage());
        }
}