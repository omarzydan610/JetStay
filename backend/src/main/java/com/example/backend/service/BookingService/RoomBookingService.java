...
public class RoomBookingService {
    ...
    public Integer bookingService(CreateBookingDTO createBookingDTO, Integer user_id) {
        ...
        for (RoomTypeBookingDTO roomTypeBookingDTO : createBookingDTO.getRoomTypeBookingDTO()) {
            bookRoom(roomTypeBookingDTO, user, hotel, checkIn, checkOut, bookingTransaction);
        }
    ...
    private void bookRoom(RoomTypeBookingDTO roomTypeBookingDTO, User user, Hotel hotel, LocalDate checkIn,
            LocalDate checkOut, BookingTransaction bookingTransaction) {
