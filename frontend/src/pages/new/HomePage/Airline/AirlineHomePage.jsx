...
import StatisticsSection from "../../../../components/new/HomePages/Airline/HomePage/StatisticsSection.jsx";
    ...
    <div className="min-h-screen relative overflow-x-hidden bg-gradient-to-br from-slate-50 via-sky-50 to-cyan-50">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-4">
          ...
          >
            Manage your flights and view real-time statistics
          </motion.p>
        </motion.div>
