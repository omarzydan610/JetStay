...
export default function UserRoomPage() {
  ...
  return (
    ...
    <div className="p-6">
        ...
        >
        {showFilter ? "Hide Filters" : "Search Rooms"}
        </button>
    </div>
    ...
    <div className="w-full p-6">
        ...
        <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <button onClick={clearFilters} className="px-3 py-1 bg-gray-200 rounded-md">
                Reset
            </button>
            <button onClick={applyFilters} className="px-3 py-1 bg-green-600 text-white rounded-md">
                Apply
            </button>
            </div>
        </div>
