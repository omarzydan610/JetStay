    ...
    <div className="min-h-screen relative overflow-x-hidden bg-gradient-to-br from-slate-50 via-sky-50 to-cyan-50">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-12">
          ...
          >
            Detailed information about all bookings
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600 text-center max-w-md">
            The booking details page is currently under development. Check back
            soon for detailed booking information and analytics.
          </p>
        </motion.div>
      </motion.div>
    </div>
