    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900 mb-2">Room Type Management</h1>
                                <p className="text-gray-600">Configure and manage your hotel room types</p>
                            </div>
                            <button
                ...
                {notification && (
                    <div
                        className={`mb-6 rounded-xl shadow-lg border ${notification.type === 'success'
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-auto pl-3">
                                    <button
                                        ...
                                        className={`inline-flex rounded-md p-1.5 focus:outline-none transition-colors ${notification.type === 'success'
