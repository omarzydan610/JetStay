        ...
        createPortal(
          <AnimatePresence>
            <motion.div
              ...
              className="bg-white rounded-xl shadow-2xl border-2 border-sky-100 w-[520px] overflow-hidden"
            >
              <div className="p-4 bg-gradient-to-br from-white via-sky-50 to-white">
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    <button
                      ...
                      className="px-2 py-2 text-xs font-semibold text-gray-700 bg-gradient-to-br from-sky-100 to-cyan-100 rounded-lg hover:from-sky-200 hover:to-cyan-200 hover:text-sky-800 border border-sky-300 transition-all duration-200 hover:shadow-md"
                    >
                      Last day
                    </button>
                    <button
                ...
                {/* Divider */}
                <div className="h-px bg-gradient-to-r from-transparent via-sky-200 to-transparent mb-4"></div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-2 py-2 border-2 border-sky-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-600 focus:border-transparent bg-white hover:border-sky-300 transition-all text-sm"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold text-gray-600 mb-1">
                ...
                {/* Calendar Section */}
                <div className="mb-4 border-2 border-sky-200 rounded-xl p-4 bg-gradient-to-br from-sky-50 to-white">
                  {/* Calendar Header */}
                  <div className="flex items-center justify-between mb-3">
                    <button
                      onClick={prevMonth}
                      className="p-1.5 hover:bg-sky-200 rounded-lg transition-colors duration-200 text-sky-600 hover:text-sky-800"
                    >
                  ...
                  <div className="grid grid-cols-7 gap-1 mb-2">
                    {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map(
                      (day) => (
                        <div
                          key={day}
                          className="text-xs font-bold text-sky-700 text-center py-1.5 bg-sky-100 rounded-md"
                        >
                          {day}
                        </div>
                      )
                    ...
                    {calendarDays.map((dayObj, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`
                            relative py-2 text-xs rounded-lg font-medium transition-all duration-150
                            ${
                ...
                <div className="flex justify-end gap-2">
                  <button
                    ...
                    className="px-4 py-2 text-sm font-semibold text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 active:bg-gray-300 transition-all duration-200 border border-gray-300 hover:shadow-md"
                  >
                    Cancel
                  </button>
                  <button
