...
import { getAirlineReviews, getAirlineReviewSummary } from '../../../../services/Airline/reviewService';
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-6">
            ...
            <div className="mb-8 pb-4 border-b border-gray-200">
                <h2 className="text-2xl font-semibold text-gray-900">Guest reviews for {airlineName}</h2>
            </div>
