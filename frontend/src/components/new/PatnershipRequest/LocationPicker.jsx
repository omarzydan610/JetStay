...
const LocationPicker = ({ latitude, longitude, onLocationChange, errors }) => {
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <button
            ...
            className={getButtonClass("geolocation")}
          >
            {isGettingLocation ? (
              "Getting Location..."
            ) : (
              <>
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs opacity-80">Use GPS</div>
                </div>
              </>
            )}
          </button>
          ...
          >
            🗺️{" "}
            <div className="text-left">
              <div className="font-medium">Map Pick</div>
              <div className="text-xs opacity-80">Click on map</div>
            </div>
          </button>
        </div>
      </div>
